...
public class A3Tester {
	...
	public static void testAddFront() {
		...
		list1.addFront("A");
		result = list1.frontToBack();
		displayResults(result.equals("{A}"), "testAddFront "+result);
		
		list1.addFront("V");
		list1.addFront("A");
		list1.addFront("J");
		result = list1.frontToBack();
		displayResults(result.equals("{JAVA}"), "testAddFront "+result);
		result = list1.backToFront();
		displayResults(result.equals("{AVAJ}"), "testAddFront "+result);
	}
	...
	public static void testRemoveFront() {
		...
		displayResults(result.equals("{KNIP}"), "testRemoveFront "+result);

		list2.removeFront();
		result = list2.backToFront();
		displayResults(result.equals("{KNI}"), "testRemoveFront "+result);		
	...
	public static void testInsertInto() {
		...
		displayResults(result1.equals("{chsy}"), "insertInto h "+result1);
		
		list1.insertInto("t");
		result1 = list1.frontToBack();
		displayResults(result1.equals("{chsty}"), "insertInto t "+result1);
		
		list1.insertInto("z");
		result1 = list1.frontToBack();
		displayResults(result1.equals("{chstyz}"), "insertInto z "+result1);
	...
	public static void testRotate() {
		...
		list1.rotate(1);
		result = list1.frontToBack();
		displayResults(result.equals("{GABCDEF}"), "testRotate "+result);
		
		list1.rotate(3);
		result = list1.frontToBack();
		displayResults(result.equals("{DEFGABC}"), "testRotate "+result);
