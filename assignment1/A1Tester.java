...
public class A1Tester {
	...
	public static void testGreatestCommonDenominator() {
		...
		result = A1Exercises.greatestCommonDenominator(48,18);
		expected = 6;
		System.out.println("Expected : "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(35,22);
		expected = 1;
		System.out.println("Expected : "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(0,42);
		expected = 42;
		System.out.println("Expected : "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(42,0);
		expected = 42;
		System.out.println("Expected : "+expected);
		System.out.println("Returned: "+result);


		result = A1Exercises.greatestCommonDenominator(1,18);
		expected = 1;
		System.out.println("Expected : "+expected);
		System.out.println("Returned: "+result);
	}
