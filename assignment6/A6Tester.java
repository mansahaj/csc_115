	...
	public static void danceClubTests() {
		...
		try {
			...
			if (result == null) {
				...
				displayResults(result.equals(expected), "handled first clubber in line 2 "+result.toString() +d.clubbersInLine());
			}
		} catch (Exception e) {
			System.out.println("exception thrown");
			displayResults(false, "handled first clubber in line 2");
		...
		try {
			...
			if (result == null) {
				...
				displayResults(result.equals(expected), "handled first clubber in line 4 "+result);
			}
		} catch (Exception e) {
			System.out.println("exception thrown");
			displayResults(false, "handled first clubber in line 4");
		...
		try {
			...
			displayResults(numRemoved==5, "group of 5 enters dance club "+numRemoved);
		} catch (Exception e) {
		...
		try {
			...
			displayResults(numRemoved==2, "group of 2 enters dance club "+numRemoved);
		} catch (Exception e) {
